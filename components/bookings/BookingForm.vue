      ...
      <div v-show="selectedEvent.event_type_id === 'dinner'" class="form-element-gray">
        ...
        <div class="md:flex flex-wrap -mx-1">
          <div v-for="team in teams" :key="team.name" class="md:w-1/2 p-1">
            <div
              :class="[
                team === dinnerForm.team ? 'bg-brand-400 text-white' : 'hover:bg-brand-200',
                'bg-brand-100 rounded px-3 py-2 tracking-wider flex items-center cursor-pointer shadow',
              ]"
        ...
        <div class="md:flex">
          <div class="md:w-1/2 flex flex-wrap -m-1">
            <div
              ...
              :key="restriction"
              :class="[
                dinnerForm.diet.includes(restriction) ? 'bg-brand-400 text-white' : 'hover:bg-brand-200',
                'bg-brand-100 rounded px-3 py-1 tracking-wider flex-1 text-center m-1 cursor-pointer shadow',
              ]"
