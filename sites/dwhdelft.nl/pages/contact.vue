...
<template>
  <div>
    ...
    <section class="container mx-auto px-4 py-12 flex items-start">
      <div class="flex-1">
        <ContactForm />
      </div>
      <div class="w-1/3 border-l pl-6 ml-6">
        <ContactOptions email="bestuur@dwhdelft.nl" :dark="true" />
        <a
          href="https://my.dwhdelft.nl"
          class="block bg-purple-800 hover:bg-purple-700 rounded-xl text-white p-4 w-2/3 shadow"
        >
          {{ $t('my') }}
    ...
    <section class="relative info pt-48 md:py-32 text-gray-800">
      <div class="container px-4 mx-auto flex space-x-16 relative z-10">
        <div class="md:pt-16">
    ...
    <div class="bg-purple-800 -mt-96 pt-96">
      <section class="container mx-auto px-4 mt-20 py-12">
        <h1 class="text-white font-medium text-5xl mb-12" v-html="$t('titles.board')" />
        <div class="grid grid-cols-2 gap-6">
          <div
            v-for="member in boardMembers"
            :key="member.name"
            class="flex rounded-lg shadow bg-white overflow-hidden"
          >
            <div class="bg-purple-450 w-32" />
            <div class="p-6">
              <div class="mb-8">
                <div class="font-bold text-xl text-purple-450" v-text="member.name" />
                <span v-text="$tt(member.description)" />
              </div>
              <div class="bg-purple-100 rounded-full flex items-center pl-3 pr-4 py-1 text-purple-450 space-x-2">
