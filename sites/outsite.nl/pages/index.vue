...
en:
  ...
  description:
    ...
    invitation: 'Come by during one of our bar nights:<br> <strong>Every Thursday starting at 21:00</strong>'
  video:
...
nl:
  ...
  description:
    ...
    invitation: 'Kom gerust langs op onze baravond: <br> <strong>Elke donderdag vanaf 21:00</strong>'
  video:
...
<template>
  <div>
    ...
    <section class="introduction">
      <div class="container mx-auto pt-12 pb-24 md:flex md:justify-between">
