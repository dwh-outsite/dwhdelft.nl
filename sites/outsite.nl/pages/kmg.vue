...
en:
  ...
  next:
    ...
    see you there! <strong>The next Introduction Group will start in February 2024</strong>.
  form:
...
nl:
  ...
  next: Net als Outsite is de KMG gericht op jongeren en jongvolwassenen tot en met 28 jaar. De KMG vindt plaats
    ...
    <strong>De volgende KennisMakingsGroep start in februari 2024</strong>.
  form:
